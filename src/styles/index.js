const styles = {
    ...
    downloadBtn: 'button w-max-content lg:w-[250px] flex flex-col items-center justify-center transition duration-400 border border-transparent text-white text-center gap-3 px-5 py-5 lg:py-8 rounded-lg bg-slate-950',
    ...
    paddings: 'p-10 py-20 lg:px-40 lg:py-10',
    ...
    // hero section
    heroHeading:
        'font-bold lg:text-[144px] md:text-[100px] sm:text-[60px] text-[60px] lg:leading-[158.4px] md:leading-[114.4px] sm:leading-[74.4px] leading-[64.4px] uppercase text-red-500',
    heroDText:
